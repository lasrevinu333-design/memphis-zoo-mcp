...
export const MCP_TOOL_MANIFEST = Object.freeze([
  ...
  },
  {
    ...
    requires: ["github"],
    inputs: ["repo", "path", "content", "commit_message", "branch", "overwrite", "expected_sha", "dry_run"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.SAFE_WRITE,
    status: "current",
    description: "Update an existing file with mandatory caller-pinned SHA, replace exact text, or restore from ref using a JSON command.",
    requires: ["github"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.SAFE_WRITE,
    status: "current",
    description: "Replace exact text in an existing file with mandatory caller-pinned SHA protection and compact diff preview.",
    requires: ["github"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.SAFE_WRITE,
    status: "current",
    description: "Restore a file on the target branch from a commit, branch, or tag with mandatory caller-pinned target SHA.",
    requires: ["github"],
