...
export const MCP_TOOL_MANIFEST = Object.freeze([
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.READ,
    status: "current",
    description: "List files and directories in an allowed GitHub repository. Also supports search:term and search-content:term path commands.",
    requires: ["github"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.READ,
    status: "current",
    description: "Read one file from an allowed GitHub repository. Also supports manifest and batch-read compatibility commands.",
    requires: ["github"],
  ...
  },
  {
    ...
    status: "current",
    description: "Create a file, overwrite only when explicitly allowed, or run branch/PR JSON commands through content. Dry-run defaults to true in the modular layer.",
    requires: ["github"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.SAFE_WRITE,
    status: "current",
    description: "Update an existing file, or replace exact text when find and replace are supplied. Dry-run defaults to true in the modular layer.",
    requires: ["github"],
  ...
  },
  {
    ...
    safety: TOOL_SAFETY.SAFE_WRITE,
    status: "current-via-compatibility-command",
    description: "Preview a text replacement with unified diff through github_update_file or github_replace_text with dry_run:true.",
    requires: ["github"],
