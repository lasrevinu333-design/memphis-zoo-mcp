...
const SYSTEM_INTENT_PATTERN = /\b(schedule|assigned|assignment|works|working|scheduled|staff|staffing|cover|coverage|candidate|backup|absence|absent|off|open segment|uncovered|unassigned|ticket|maintenance|dashboard|attendance|scan|owner|location|event|employee|workload|load|area|group|restroom|aquarium|zambezi|teton|expo|pavilion|clean|cleans|cleaned)\b/i;
