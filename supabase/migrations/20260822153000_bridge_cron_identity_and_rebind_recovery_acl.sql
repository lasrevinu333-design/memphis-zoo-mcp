...
create or replace function cron.custodial_schema_identity_cron_jobs()
returns table(
  jobname text,
  schedule text,
  command text,
...
alter function cron.custodial_schema_identity_cron_jobs() owner to supabase_admin;
revoke all privileges on function cron.custodial_schema_identity_cron_jobs()
  from public, anon, authenticated, service_role;
grant execute on function cron.custodial_schema_identity_cron_jobs()
...
begin
  ...
  if not has_function_privilege(
    ...
    'cron.custodial_schema_identity_cron_jobs()',
    'execute'
