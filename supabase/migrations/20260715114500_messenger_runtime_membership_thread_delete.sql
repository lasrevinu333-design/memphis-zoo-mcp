-- Keep Memphis Messenger limited to active custodial runtime identities and make
-- thread deletion server-authoritative across browser reloads and device aliases.
...
begin
  ...
  -- Thread listing is participant based. Leaving the participant row is the
  -- server-side deletion boundary; opening Memphis later creates a clean thread.
