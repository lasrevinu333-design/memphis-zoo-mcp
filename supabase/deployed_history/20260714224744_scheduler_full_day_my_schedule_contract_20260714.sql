-- Deployed migration history snapshot: 20260714224744 scheduler_full_day_my_schedule_contract_20260714
...
begin
  ...
  v_local_now := p_now at time zone 'America/Chicago';
  ...
  return v_base || jsonb_build_object(
    ...
    'contract_version', 'my_schedule.v2'
  );
end
$function$;
