...
assert.throws(() => assertFrontendReleaseIdentity({ frontend_commit_sha: "6fae503111ef21c40a309913965c3b963043aa01" }, input), /frontend_commit_sha/, "the superseded frontend must not satisfy current candidate admission");
