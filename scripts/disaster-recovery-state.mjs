...
const SNAPSHOT_CATEGORIES = [
  ...
  { category: "cleaning_sessions", schema: "public", table: "sessions", fields: ["id", "session_uuid", "client_session_id", "location_id", "employee_id", "device_id", "status", "started_at", "ended_at", "created_at", "updated_at"] },
