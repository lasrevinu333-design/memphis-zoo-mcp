...
const staticWeeklyCompactDocumentConsumers = "20260824131500_static_weekly_compact_document_consumers.sql";
...
assert.equal(pendingMigrationPlan.target?.source_migration_file, staticWeeklyCompactDocumentConsumers);
