...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260810210000_static_weekly_scheduler_three_high_foundation_correction.sql");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 64);
assert.equal(releaseEvidence.migrations.length, 64);
