...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260813141806_custodial_operational_boundary_closure.sql");
...
assert.equal(releaseEvidence.frontend_commit_sha, "95e055fec0113f16378101408e6bcb485a6f57eb");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 73);
assert.equal(releaseEvidence.migrations.length, 73);
