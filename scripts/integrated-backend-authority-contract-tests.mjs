...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260810230000_static_weekly_scheduler_authority_closure_correction.sql");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 66);
assert.equal(releaseEvidence.migrations.length, 66);
