...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260810220000_static_weekly_scheduler_complete_authority_correction.sql");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 65);
assert.equal(releaseEvidence.migrations.length, 65);
