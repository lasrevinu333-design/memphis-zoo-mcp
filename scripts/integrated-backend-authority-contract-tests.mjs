...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260813035530_offline_scan_authority_snapshot.sql");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 69);
assert.equal(releaseEvidence.migrations.length, 69);
