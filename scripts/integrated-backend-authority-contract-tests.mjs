...
assert.equal(releaseEvidence.migrations.at(-1).name, "20260820143200_finalize_function_authority_recovery.sql");
...
assert.equal(releaseEvidence.authority_content_identity.migration_path_count, 87);
assert.equal(releaseEvidence.migrations.length, 87);
