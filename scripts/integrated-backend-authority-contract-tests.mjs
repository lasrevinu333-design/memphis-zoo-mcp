...
assert.match(releaseEvidence.compatibility_window.u4_ops_closure_phase,
  /wire timestamps.*activation boundaries.*UUID completion.*event delivery.*native notification receipts.*notification recovery authority.*terminal notification retries.*authority set/);
...
assert.equal(releaseEvidence.frontend_commit_sha, "d789dd7a9427355b0b3b6fd443e179b2a545c730");
