...
const output = {
  ...
  compatibility_window: {
    ...
    u4_ops_closure_phase: "20260813210000 canonicalizes native wire timestamps, records immutable activation boundaries, enforces UUID completion identities, atomically binds employee event delivery and terminal notification retries, and restores the catalog-derived authority set",
  },
