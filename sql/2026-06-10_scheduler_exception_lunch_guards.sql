-- Guard response-only/reminder exception rows from lunch splitting. Current
-- generated response-only rows are repaired by a separate exact-ID script so
-- this function migration can be applied independently and safely.
